...
class NativeOboeWave: WavetableSynthesizer ,DefaultLifecycleObserver {
    ...
    override suspend fun setWavetable(wavetable: OboeWaveEnum) = withContext(Dispatchers.Default) {
        synchronized(synthesizerMutex) {
            createNativeHandleIfNotExists()
